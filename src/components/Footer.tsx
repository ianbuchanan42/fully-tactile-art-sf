      ...
      <div className='container mx-auto px-4'>
        <div className='md:flex md:justify-between'>
          ...
          >
            ...
            <section aria-labelledby='connect-heading' className='mt-6'>
          ...
          <section
            ...
            className='md:w-1/2'
          >
            <h2 id='fiscal-sponsor-heading' className='font-semibold sr-only'>
              Fiscal Sponsorship
            </h2>
            ...
            <div className='flex items-center mb-4'>
              ...
              <div>
                <h3 className='font-semibold'>Fiscal Sponsorship</h3>
