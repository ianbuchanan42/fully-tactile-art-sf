...
export default function Navigation() {
  ...
  return (
    <>
      ...
      <a
        href='#main-content'
        className='sr-only focus:not-sr-only focus:absolute focus:z-50 focus:p-4 focus:bg-white focus:text-blue-600 focus:border-2 focus:border-blue-600 focus:top-2 focus:left-2 focus:outline-none'
      >
